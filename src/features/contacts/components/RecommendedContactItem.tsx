...
const RecommendedContactItem = ({ contactId }: RecommendedContactItemProps) => {
  ...
  return (
    <li
      ...
      className="flex w-12 cursor-pointer flex-col items-center gap-1 rounded-md transition hover:bg-gray-50"
    >
      <UserIcon
      ...
      />
      <p className="w-full truncate text-center text-sm">{contact?.username}</p>
    </li>
  );
};
